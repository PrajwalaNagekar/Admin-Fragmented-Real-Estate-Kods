import {
  ...
  IndianRupee, TrendingUp, UserCheck, Wrench, FileText, Megaphone,
...
const navItems = [
  ...
  { title: "Financials", url: "/financials", icon: IndianRupee },
  ...
  return (
    <Sidebar className="w-64 border-r border-sidebar-border bg-sidebar">
      <div className="flex items-center gap-3 px-6 py-5 border-b border-sidebar-border">
        ...
        <div>
          <span className="text-base font-bold text-foreground tracking-tight block leading-none text-white">One Property</span>
